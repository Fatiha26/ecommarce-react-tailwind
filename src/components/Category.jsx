    ...
    <div>
      <div className='grid md:grid-cols-2 w-full md:h-screen'>
         <div style={{ 
               backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.5), 
                  ...
                  }} className='w-full h-[400px] md:h-screen bg-no-repeat bg-cover bg-center'>
               <div className='flex justify-center items-center flex-col md:pt-64 pt-40'>
         ...
         <div style={{ 
               backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.3), 
                  ...
                  }} className='w-full h-[400px] md:h-screen bg-no-repeat bg-center bg-cover'>
             <div className='flex justify-center items-center flex-col md:pt-64 pt-40'>
      ...
      <div style={{ 
               backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.3), 
                  ...
                  }} className='w-full  h-[400px] md:h-screen bg-no-repeat bg-top bg-cover'>
             <div className='flex justify-center items-center flex-col md:pt-64 pt-40'>
